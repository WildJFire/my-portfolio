...
public class HotUpdateTest : MonoBehaviour
{
    void Start()
    {
        ...
        /*_buttonChangeIcon = GameObject.Find("Button_ChangeIcon").GetComponent<Button>();
        _buttonChangeIcon.onClick.AddListener(OnChangeIcon);

        _buttonChangeBackground = GameObject.Find("Button_ChangeBackground").GetComponent<Button>();
        _buttonChangeBackground.onClick.AddListener(OnChangeBackground);

        _buttonLoadModel = GameObject.Find("Button_LoadModel").GetComponent<Button>();
        _buttonLoadModel.onClick.AddListener(OnLoadModel);

        _buttonUnloadModel = GameObject.Find("Button_UnloadModel").GetComponent<Button>();
        _buttonUnloadModel.onClick.AddListener(OnUnloadModel);

        _buttonChangeScript = GameObject.Find("Button_ChangeBearSprite").GetComponent<Button>();
        _buttonChangeScript.onClick.AddListener(OnChangeBear);

        _rawImage_bg = GameObject.Find("RawImage_Background").GetComponent<RawImage>();
        _rawImage_icon = GameObject.Find("RawImage_Icon").GetComponent<RawImage>();
        _rawImage_Bear = GameObject.Find("Image_Bear").GetComponent<Image>();
        
        _text = GameObject.Find("TestText").GetComponent<TextMeshProUGUI>();*/
    }
    ...
    [SerializeField] private RawImage _rawImage_bg;
    [SerializeField] private RawImage _rawImage_icon;
    [SerializeField] private Image _rawImage_Bear;

    [SerializeField] private Transform _modelRoot;
    [SerializeField] private TextMeshProUGUI _text;
    [SerializeField] private Button _buttonChangeIcon;
    [SerializeField] private Button _buttonChangeBackground;
    [SerializeField] private Button _buttonLoadModel;
    [SerializeField] private Button _buttonUnloadModel;
    [SerializeField] private Button _buttonChangeScript;
    ...
    public void OnChangeBackground()
    {
        ...
        _text.SetText(nameof(OnChangeBackground) + url);
    ...
    public void OnChangeBear()
    {
        ...
        _text.SetText(nameof(OnChangeBear) + bearUrl);
        //同步加载人物的sprite
    ...
    public void OnChangeIcon()
    {
        ...
        _text.SetText(nameof(OnChangeIcon) + iconUrl);
    ...
    public void OnLoadModel()
    {
        if (_modelResource != null)
            return;
        _text.SetText(nameof(OnLoadModel)+_modelUrl);
    ...
    public void OnUnloadModel()
    {
        if (_modelResource == null)
            return;
        _text.SetText(nameof(OnUnloadModel)+_modelUrl);
